...
const catalogItemScema = new Schema({
    ...
    drawingFiles: {type: Array<string>, required:true},//s3
    costAdmin: {type: Number, required:true},
    partnerCodeAdmin: {type: String, required:true},
    
});

export default mongoose.model<catalogInterface>("CatalogItem", catalogItemScema)

//include image url && use s3 bucket
