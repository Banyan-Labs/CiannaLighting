...
const Inventory: FC = () => {
    ...
    return (
        <div className="inventory-container">
            ...
            <form className="inventory-form" tabIndex={-1} onSubmit={onSubmit}>
                <div className="tabs">
                    <div className="tab">
                        <input tabIndex={-1} type="checkbox" id="chck1" defaultChecked />
                ...
                <button tabIndex={-1} id="inventory-btn">Submit</button>
            </form>
        </div>
    );
};
