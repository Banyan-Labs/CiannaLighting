...
const SingleRoom: FC<SingleRoomProps> = ({ light, project, image, editLightFunc, deleteLightFunc }) => {
    ...
    return (
        <div className="single-room-container d-flex flex-column">
                ...
                <div className="d-flex flex-column col-6 ms-1">
                    <div className="d-flex flex-row justify-content-between">
                        <div className="project-name">
                            <span className="project-tag">Quantity ({light?.quantity || 0})</span>
                        </div>
            ...
            <div>
                <div className="project-name">
                    <p
                        className={isCollapsed ? "cursor-pointer d-flex mt-0 project-tag collapsed" : "align-items-center cursor-pointer d-flex mt-0 project-tag expanded"}
